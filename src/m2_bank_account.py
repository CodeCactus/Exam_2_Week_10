...
class Bank(object):
    ...
    def withdraw(self, amount):
        ...
        if amount>self.balance:
            print('No can do')
            print ('you would be '+str(self.balance-amount)+'in debt')
        else:
...
def run_test_init():
    ...
    b3 = Bank('Jeff Bezos', 999999999, 'A3')
    expected_name = 'Jeff Bezos'
